		...
		if (strstr($links, "|")){
			...
			if (ucfirst($links) == $title) {
				...
				if (file_exists($ID."contents/".ucfirst($links).".cont")) {
					$content = str_replace('(('.$links.'))', '<a href="index.php?title='.ucfirst($links).'">'.$links.'</a>', $content);
				} else {
...
if (file_exists($ID."contents/".$title.".cont")) {
	if (isset($_SESSION['user'])) {
		if (in_array($_SESSION['user'], $admin, true)) {
			echo '<ul class="navbuttons"><li class="navbuttons"><a class="navbuttons" href="'.$IURL.'index.php?title='.$title.'&action=edit">Edit</a></li><li class="navbuttons"><a class="navbuttons" href="'.$IURL.'index.php?title='.$title.'&action=history">History</a></li><li class="navbuttons"><a class="navbuttons" href="'.$IURL.'index.php?title='.$title.'&action=move">Move</a></li><li class="navbuttons"><a class="navbuttons" href="'.$IURL.'index.php?title='.$title.'&action=delete">Delete</a></li><li class="navbuttons"><a class="navbuttons" href="'.$IURL.'index.php?title='.$title.'&action=protect">Protect</a></li></ul><br>';
		} else {
			echo '<ul class="navbuttons"><li class="navbuttons"><a class="navbuttons" href="'.$IURL.'index.php?title='.$title.'&action=edit">Edit</a></li><li class="navbuttons"><a class="navbuttons" href="'.$IURL.'index.php?title='.$title.'&action=history">History</a></li><li class="navbuttons"><a class="navbuttons" href="'.$IURL.'index.php?title='.$title.'&action=move">Move</a></li></ul><br>';
		}
	} else {
...
<?php
//if (file_exists($ID."contents/".$title.".cont")) {
//	require $ID."contents/".$title.".cont";
//} else {
//	echo '';
//}
echo $content;
